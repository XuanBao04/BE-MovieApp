...
import com.example.spring3.dto.response.VNPayResponse;
...
public class PaymentController {
    ...
    public ResponseEntity<VNPayResponse> createPayment(HttpServletRequest request) throws UnsupportedEncodingException {
